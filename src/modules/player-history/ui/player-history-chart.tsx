...
import { formatHistoryPointDate } from '@/modules/player-history/lib/history-formatters';
import { resolvePlayerHistoryKeyboardAction } from '@/modules/player-history/lib/player-history-chart-keyboard';
import {
...
export default function PlayerHistoryChart({
  ...
  const handleKeyDown = (event: KeyboardEvent<HTMLButtonElement>) => {
    const action = resolvePlayerHistoryKeyboardAction(event.key);
